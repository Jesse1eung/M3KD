...
@registry.register_model("albef_glue")
class AlbefGlue(AlbefBase, MomentumDistilationMixin):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "sst2": "configs/models/albef/albef_classification_glue.yaml",
        "mnli": "configs/models/albef/albef_classification_glue.yaml",
    }
    ...
    def forward(self, samples, is_train=True):
        ...
        sentences2 = None
        if 'text_input2' in samples.keys():
            sentences2 = samples["text_input2"]
        ...
        if is_train:
            ...
            image_embeds, image_embeds_m, encoder_output_m, prediction_m = None, None, None, None
    ...
    def from_config(cls, cfg=None):
        ...
        # fusion_layer=cfg.get("fusion_layer", 6)
