...
class BaseDatasetBuilder:
        ...
        for split in splits:
            ...
            for url_or_filename, storage_path in zip(urls, storage_paths):
                ...
                if os.path.isfile(url_or_filename):
                    ...
                    print(url_or_filename, filename)
    ...
    def build(self):
        ...
        for split in ann_info.keys():
            if split not in ["train", "val", "test","test1","test2","test3","test4","test5", "txt_train", "img_train"]:
                continue

            is_train = split == ("train") or split==  ("txt_train") or split==("img_train")
