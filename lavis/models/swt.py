...
class SwinTransformerEncoder(SwinTransformer, BaseEncoder):
    @classmethod
    def from_config(cls, config, load_params=False):
        ...
        vision_encoder = cls(img_size=vision_config['image_res'],
                                         patch_size=4,
                                         in_chans=3,
