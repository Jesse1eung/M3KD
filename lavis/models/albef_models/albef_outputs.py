...
class AlbefOutput(ModelOutput):
    ...
    loss_img: Optional[torch.FloatTensor] = None
    loss_logits: Optional[torch.FloatTensor] = None
    loss_itc_distill: Optional[torch.FloatTensor] = None
    loss_it_hid: Optional[torch.FloatTensor] = None

    loss_reps: Optional[torch.FloatTensor] = None
