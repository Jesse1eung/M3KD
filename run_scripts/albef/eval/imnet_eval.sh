...
--nproc_per_node=4 \
evaluate.py --cfg-path lavis/projects/albef/eval/imagenet_eval.yaml \
--options run.num_workers=1 run.batch_size_eval=1024 \
model.pretrained="./lavis/output/albef/ft_imnet/202306020952/checkpoint_0.pth"
